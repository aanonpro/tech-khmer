...
<main>
    ...
    <div class="about-area2 gray-bg pt-60 pb-60">
        <div class="container">
				...
				<?php
					$contents = $conn->query("SELECT * FROM tb_content WHERE status=1 AND trash = 0 order by created_at DESC LIMIT 4");
							while($crow = $contents->fetch()){?>
												
								<div class="col-xl-6 col-lg-6 col-md-6">
									<div class="whats-news-single mb-40 mb-40">
										<div class="whates-img">
											<img src="<?php echo "images/".$crow['pic_cover'];?>" alt="" height="245">
										</div>
										<div class="whates-caption whates-caption2">
											<h4><a href="<?php echo 'newsdetail.php?newsitems='.$crow['cont_id']; ?>"><?php echo $crow['cont_title'];?></a></h4>
											<span>by Alice cloe   -   <?php echo $crow['created_at'];?></span>
											<p><?php echo $crow['short_detail'];?></p>
										</div>
									</div>
								</div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="blog_right_sidebar"">
                            <aside class="single_sidebar_widget popular_post_widget"  style="background: #fff; border-radius: 8px">
